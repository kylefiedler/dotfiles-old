...
syn match cssFontProp contained "\<font\(-\(family\|size\|style\|variant\|weight\(-adjust\)\=\|stretch\)\)\=\>"
syn match cssFontProp contained "\<font-size\>"
...
syn match cssTextProp "\<\(\(word\|letter\)-spacing\|text\(-\(decoration\|transform\|indent\|rendering\|align\|index\|shadow\)\)\=\|vertical-align\|unicode-bidi\|line-height\)\>"
syn match cssTextAttr contained "\<line-through\>"
"syn match cssTextAttr contained "\<text-indent\>"
"syn match cssTextAttr contained "\<text-align\>"
